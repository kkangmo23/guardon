...
function emptyCheck(){
	...
	var connectIdDesc = document.check.connectIdDesc.value;
	...
	if(connectId==""||!check||connectIdDesc==""){
		...
		form.action='insertConnectId.do';
		form.submit();
		}
	}
}
...
<script type="text/javascript">
	...
	function pageMove(){
		location.href = "./insertConnectId.do?page="+asyncPaging.options.currentPage;
	}
</script>
<script type="text/javascript">
$(function() {		
...
<div class="container">
  ...
  <div class="content">
	...
	<form action="insertConnectId.do" method="post" name="check">
...
<center>
 	...
 	<br/>
 	<br/>
 	접속 아이디 설명 : <input type="text" id="connectIdDesc" name="connectIdDesc"/>
 	<br/>
 	<br/>
 	<input type="button" value="접속 아이디 등록" onclick="emptyCheck()" >
 	</center>
