...
public class RequestDAOImpl implements RequestDAO{
	...
	public int countOtpApproved(Map<String, String> map) throws Exception {
		return (int) sqlMapClient.queryForObject("Request.countOtpApproved", map);
	}

	@Override
	public ArrayList<History> getExpiredUserHistory(String userId)
			throws Exception {
		return (ArrayList<History>) sqlMapClient.queryForList("History.getExpiredUserHistory", userId);
	}

	@Override
	public ArrayList<History> getUncheckedUserHistory(String userId)
			throws Exception {
		return (ArrayList<History>) sqlMapClient.queryForList("History.getUncheckedUserHistory", userId);
	}

	@Override
	public ArrayList<History> getApprovedUserHistory(String userId)
			throws Exception {
		return (ArrayList<History>) sqlMapClient.queryForList("History.getApprovedUserHistory", userId);
	}

	@Override
	public int countExpiredUserHistory(String userId) throws Exception {
		return (int) sqlMapClient.queryForObject("History.countExpiredUserHistory", userId);
	}

	@Override
	public int countUncheckedUserHistory(String userId) throws Exception {
		return (int) sqlMapClient.queryForObject("History.countUncheckedUserHistory", userId);
	}

	@Override
	public int countApprovedUserHistory(String userId) throws Exception {
		return (int) sqlMapClient.queryForObject("History.countApprovedUserHistory", userId);
	}
